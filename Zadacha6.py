...
a=input('введите номер билета(шестиразрядное число):')
if len(a)==6:
    k=int(a[0])++int(a[1])++int(a[2])==int(a[3])++int(a[4])++int(a[5])
    print(k)
else:
    print()
    print('Вами введенное число не является шестиразрядным')